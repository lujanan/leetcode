...
func Test_busiestServers(t *testing.T) {
	...
	tests := []struct {
		...
		{"t1", args{3, []int{1, 2, 3, 4, 5}, []int{5, 2, 3, 3, 3}}, []int{1}},
		{"t2", args{3, []int{1, 2, 3, 4}, []int{1, 2, 1, 2}}, []int{0}},
		{"t3", args{3, []int{1, 2, 3}, []int{10, 12, 11}}, []int{0, 1, 2}},
		{"t4", args{3, []int{1, 2, 3, 4, 8, 9, 10}, []int{5, 2, 10, 3, 1, 2, 2}}, []int{1}},
		{"t5", args{1, []int{1}, []int{1}}, []int{0}},
		{"t6", args{7, []int{1, 3, 4, 5, 6, 11, 12, 13, 15, 19, 20, 21, 23, 25, 31, 32}, []int{9, 16, 14, 1, 5, 15, 6, 10, 1, 1, 7, 5, 11, 4, 4, 6}}, []int{0}},
	}
