...
func Test_kidsWithCandies(t *testing.T) {
	...
	tests := []struct {
		...
		{"t1", args{[]int{2, 3, 5, 1, 3}, 3}, []bool{true, true, true, false, true}},
		{"t2", args{[]int{4, 2, 1, 1, 2}, 1}, []bool{true, false, false, false, false}},
		{"t3", args{[]int{12, 1, 12}, 10}, []bool{true, false, true}},
	}
