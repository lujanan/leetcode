...
func Test_restoreString(t *testing.T) {
	...
	tests := []struct {
		...
		{"t1", args{"codeleet", []int{4, 5, 6, 7, 0, 2, 1, 3}}, "leetcode"},
		{"t2", args{"abc", []int{0, 1, 2}}, "abc"},
		{"t3", args{"aiohn", []int{3, 1, 4, 2, 0}}, "nihao"},
		{"t4", args{"aaiougrt", []int{4, 0, 2, 6, 7, 3, 1, 5}}, "arigatou"},
		{"t5", args{"art", []int{1, 0, 2}}, "rat"},
	}
