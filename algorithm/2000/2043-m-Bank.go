...
//银行共有 n 个账户，编号从 1 到 n 。每个账号的初始余额存
...
//
// Related Topics 设计 数组 哈希表 模拟 👍 40 👎 0
...
func (this *Bank) Transfer(account1 int, account2 int, money int64) bool {
	if this.Lenght < account1 || account1 < 1 ||
		this.Lenght < account2 || account2 < 1 {
		return false
	}
	// 余额不足
...
func (this *Bank) Deposit(account int, money int64) bool {
	if account < 1 || this.Lenght < account {
		return false
	}
...
func (this *Bank) Withdraw(account int, money int64) bool {
	if account < 1 || this.Lenght < account || this.Balance[account-1] < money {
		return false
	}
	this.Balance[account-1] -= money
	return true
